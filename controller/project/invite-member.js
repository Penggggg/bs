...
exports.inviteMember = function (ctx) { return __awaiter(_this, void 0, void 0, function () {
    var model, userSocket, fromUID, toUID, PID, content, type, data, _id, content_1, title, readed, meta, result, _a;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (userSocket.checkIsOnline(toUID)) {
                    ...
                    _id = data._id, content_1 = data.content, title = data.title, readed = data.readed, meta = data.meta;
