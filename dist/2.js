...
var IModal_1 = __webpack_require__(1432);
        ...
        _this.submitAddTask = function () {
            ...
            _this.props.form.validateFields([formTaskName], function (err, values) {
                if (!err && _this.taskExecutorID.length !== 0) {
                    http_service_1.default.post('/api/v1/add-task', { creatorID: _this.user._id, title: values[formTaskName], groupID: selectGroupID, executorsID: taskExecutorID, pid: pid })
                        .do(function (res) {
                        if (res.status === '200') {
                            notification_service_1.default.open({
                                title: '消息',
                ...
                React.createElement("ul", null,
                    userTasks.map(function (task, k) { return !task.finished ? React.createElement("li", { key: k, onClick: function () { return _this.showTask(task._id); } },
                        ...
                        React.createElement("div", { className: "content" },
                            React.createElement("h3", { style: { marginBottom: 30, fontSize: 18 } }, task.content),
                            React.createElement("div", { className: "other" }, task.childTasksID.length !== 0 ?
                                React.createElement("div", null,
                                    React.createElement(antd_1.Tag, { color: "#49a9ee" }, "\u4EFB\u52A1\u8FDB\u5EA6"),
                            ...
                            React.createElement("div", { className: "member" },
                                ...
                                React.createElement(antd_1.Tooltip, { title: "\u603B\u8D1F\u8D23\u4EBA: " + task.groupID.creatorID.name },
                                    React.createElement("span", null,
                                        React.createElement(Image_component_1.default, { src: "/static/touxiang.png" }))),
                                task.groupID.leadersID.map(function (leader, k) { return React.createElement(antd_1.Tooltip, { title: "\u7EC4\u957F\uFF1A" + leader.name, key: k },
                                    React.createElement("span", null,
                                        React.createElement(Image_component_1.default, { src: "/static/touxiang.png" }))); }),
                                task.executorsID.map(function (exe, k) { return React.createElement(antd_1.Tooltip, { title: "\u6267\u884C\u8005\uFF1A" + exe.name, key: k },
                                    React.createElement("span", null,
                                        React.createElement(Image_component_1.default, { src: "/static/touxiang.png" }))); })))) : ""; }),
                    userTasks.map(function (task, k) { return task.finished ? React.createElement("li", { key: k, onClick: function () { return _this.showTask(task._id); } },
                        React.createElement("h1", { className: "title" },
...
var IModel = (function (_super) {
    ...
    function IModel() {
        ...
        _this.submitContent = function () {
            var uid = _this.uid;
            var tid = _this.props.tid;
            var contentValue = _this.state.contentValue;
            var pid = _this.state.task.groupID.pid;
            if (_this.authCheck()) {
                http_service_1.default.post('/api/v1/update-task-content', {
                    content: contentValue, creatorID: uid, _id: tid, pid: pid
                })
                    .do(function (res) {
                    if (res.status === '200') {
                        _this.setState({
        ...
        _this.submitTask = function () {
            var uid = _this.uid;
            var tid = _this.props.tid;
            var childTaskValue = _this.state.childTaskValue;
            var pid = _this.state.task.groupID.pid;
            if (_this.authCheck()) {
                http_service_1.default.post('/api/v1/add-child-task', {
                    content: childTaskValue, creatorID: uid, taskID: tid, pid: pid
                })
                    .do(function (res) {
                    if (res.status === '200') {
                        _this.setState({
        ...
        _this.submitDate = function (date, dateString) {
            ...
            var pid = _this.state.task.groupID.pid;
            if (_this.authCheck()) {
                http_service_1.default.post('/api/v1/update-deadline', { pid: pid, _id: tid, deadLine: String((new Date(dateString)).getTime()) })
                    .do(function (res) {
                    if (res.status === '200') {
                        _this.setState({
                            task: res.data
    ...
    IModel.prototype.render = function () {
        var _this = this;
        var _a = this.state, spinning = _a.spinning, task = _a.task, chatValue = _a.chatValue, contentValue = _a.contentValue, showContentEdit = _a.showContentEdit, childTaskValue = _a.childTaskValue, showChildTaskEdit = _a.showChildTaskEdit;
            ...
            React.createElement(antd_1.Spin, { spinning: spinning, size: "large" }, task ?
                React.createElement("div", null,
                    ...
                    React.createElement("div", { className: "content" },
                        ...
                        React.createElement("pre", { style: { paddingTop: 10 } }, task.content),
                        React.createElement("div", { className: showContentEdit ? "edit-block show" : "edit-block" },
                            React.createElement("textarea", { type: "textarea", className: "ant-input", rows: 3, value: contentValue, onChange: function (e) { return _this.setState({ contentValue: e.target.value }); } }),
                            React.createElement(antd_1.Button, { onClick: this.submitContent }, "\u786E\u5B9A"))),
                    React.createElement("div", { className: "child-task-list" },
                        React.createElement("h5", null, "\u5B50\u4EFB\u52A1\u5217\u8868"),
                        ...
                        task.childTasksID.length !== 0 ?
                            ...
                            : "",
                        React.createElement("div", { className: showChildTaskEdit ? "edit-block show" : "edit-block" },
                            React.createElement("textarea", { type: "textarea", className: "ant-input", rows: 2, value: childTaskValue, onChange: function (e) { return _this.setState({ childTaskValue: e.target.value }); } }),
                            React.createElement(antd_1.Button, { onClick: this.submitTask }, "\u786E\u5B9A"))),
                    React.createElement("div", { className: "member" },
